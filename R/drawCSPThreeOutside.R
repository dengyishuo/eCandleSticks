...
#' csp_three_outside_data <- addCSPThreeOutside(AAPL)
#'
#' # Add Three Outside points
#' result_with_three_outside <- drawCSPThreeOutside(result, csp_three_outside_data)
#'
#' # Display the combined plot with Three Outside points
#' print(result_with_three_outside$combined_plot)
#' }
drawCSPThreeOutside <- function(eCandleSticks_result, csp_three_outside_result,
