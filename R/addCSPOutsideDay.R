...
#' csp_outside_day_data <- CSPOutsideDay(AAPL) # This returns a data frame with OutsideDay column
#'
#' # Add Outside Day points
#' result_with_outside_day <- addCSPOutsideDay(result, csp_outside_day_data)
#'
#' # Display the combined plot with Outside Day points
#' print(result_with_outside_day$combined_plot)
#' }
addCSPOutsideDay <- function(eCandleSticks_result, csp_outside_day_result,
