...
#' addCSPNLongWhiteCandleBodies(YHOO)
#' }
#'
...
addCSPNLongWhiteCandleBodies <- function(x, N = 2, n = 20, threshold = 1,
  ...
  LWCB <- addCSPLongCandleBody(TS, n = n, threshold = threshold)[, 1] # LongWhiteCandleBody
