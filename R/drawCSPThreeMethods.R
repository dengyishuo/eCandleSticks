...
#' csp_three_methods_data <- addCSPThreeMethods(AAPL)
#'
#' # Add Three Methods patterns
#' result_with_patterns <- drawCSPThreeMethods(result, csp_three_methods_data)
#'
#' # Display the combined plot with pattern points
#' print(result_with_patterns$combined_plot)
#' }
drawCSPThreeMethods <- function(eCandleSticks_result, csp_three_methods_result,
