...
#' csp_long_candle_body_data <- addCSPLongCandleBody(AAPL)
#'
#' # Add Long Candle Body points
#' result_with_long_candle_body <- drawCSPLongCandleBody(result, csp_long_candle_body_data)
#'
#' # Display the combined plot with Long Candle Body points
#' print(result_with_long_candle_body$combined_plot)
#' }
drawCSPLongCandleBody <- function(eCandleSticks_result, csp_long_candle_body_result,
