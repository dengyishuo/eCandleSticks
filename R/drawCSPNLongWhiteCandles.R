...
#' csp_n_long_white_data <- addCSPNLongWhiteCandles(AAPL)
#'
#' # Add N Long White Candles points
#' result_with_n_long_white <- drawCSPNLongWhiteCandles(result, csp_n_long_white_data)
#'
#' # Display the combined plot with N Long White Candles points
#' print(result_with_n_long_white$combined_plot)
#' }
drawCSPNLongWhiteCandles <- function(eCandleSticks_result, csp_n_long_white_result,
