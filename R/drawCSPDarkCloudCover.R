...
#' csp_dark_cloud_data <- addCSPDarkCloudCover(AAPL)
#'
#' # Add Dark Cloud Cover points
#' result_with_dark_cloud <- drawCSPDarkCloudCover(result, csp_dark_cloud_data)
#'
#' # Display the combined plot with Dark Cloud Cover points
#' print(result_with_dark_cloud$combined_plot)
#' }
drawCSPDarkCloudCover <- function(eCandleSticks_result, csp_dark_cloud_result,
