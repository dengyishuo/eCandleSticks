...
#'
#' Identifies Thrusting pattern: black candle, then white closing below Bar 1 midpoint.
#'
...
#' \itemize{
#' \item Thrusting: TRUE if pattern detected
#' }
#'
#' @family pattern-2bar
#' @family pattern-bear
...
#' @export
addCSPThrusting <- function(x, output = c("xts", "tibble", "data.frame")) {
  if (!xts::is.xts(x)) {
