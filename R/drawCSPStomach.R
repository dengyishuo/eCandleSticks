...
#' csp_stomach_data <- addCSPStomach(AAPL)
#'
#' # Add Stomach points
#' result_with_stomach <- drawCSPStomach(result, csp_stomach_data)
#'
#' # Display the combined plot with Stomach points
#' print(result_with_stomach$combined_plot)
#' }
drawCSPStomach <- function(eCandleSticks_result, csp_stomach_result,
